...
class CloudStorageApplicationTests {
    ...
    private void signUpAndLoginFlow(
            String firstName,
            String lastName,
            String username,
            String password,
        ...
        wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.id("signUpSuccess"))));
        Assertions.assertEquals("You successfully signed up! you can continue to login.",
    ...
    private void createCredentialFlow(
            String URL,
    ...
    public void testSignupAuthorizationFlow() {
        ...
        signUpAndLoginFlow(firstName, lastName, username, password, driver, wait);
    ...
    public void testCreatingNote() {
         ...
         */
        createNoteFlow(title, description, driver, wait);
    ...
    @Test
    public void testUpdatingNote() {
        String firstName = "John";
        String lastName = "Doe";
        String username = "johndoe2";
        String password = "hellojohn123";

        String title = "Hello note2";
        String description = "Hello world!2";

        String updatedTitle = "Update " + title;
        String updatedDescription = "Update " + updatedTitle;
    ...
    public void testDeletingNote() {
        String firstName = "John";
        String lastName = "Doe";
        String username = "johndoe3";
        String password = "hellojohn123";

        String title = "Hello note3";
        String description = "Hello world!3";
    ...
    public void testCreatingCredential() {
        ...
        String credentialUsername = "random";
        ...
        //Create credential
        createCredentialFlow(URL, credentialUsername, credentialPassword, driver, wait);
    ...
    @Test
    public void testUpdatingCredential() {
        String firstName = "John";
        String lastName = "Doe";
        String username = "johndoe5";
        String password = "hellojohn123";

        String URL = "www.udacity1.com";
        String credentialUsername = "random1";
        String credentialPassword = "password123";
    ...
    public void testDeletingCredential() {
        String firstName = "John";
        String lastName = "Doe";
        String username = "johndoe6";
        String password = "hellojohn123";

        String URL = "www.udacity2.com";
        String credentialUsername = "random2";
        String credentialPassword = "password123";
        ...
        Assertions.assertNotEquals(URL, driver.findElement(By.id("credential-url")).getText());
        Assertions.assertNotEquals(credentialUsername, driver.findElement(By.id("credential-username")).getText());
        Assertions.assertNotEquals(credentialPassword, driver.findElement(By.id("credential-password")).getText());
    }
}
